...
oext=.o32
prfx=
d32_lib_objs=$+$(template_lib_objs) d_image$(oext)$-
d32_dep_libs=$+$(template_dep_libs)$-

oext=.obw
prfx=w
win_lib_objs=$+$(template_lib_objs) w_image$(oext)$-
win_dep_libs=$+$(template_dep_libs)$-

oext=.obn
prfx=n
wnt_lib_objs=$+$(template_lib_objs) w_image$(oext)$-
wnt_dep_libs=$+$(template_dep_libs)$-

oext=.ob9
prfx=9
w32_lib_objs=$+$(template_lib_objs) w_image$(oext)$-
w32_dep_libs=$+$(template_dep_libs)$-

oext=.obo
prfx=o
os2_lib_objs=$+$(template_lib_objs) o_image$(oext)$-
...
W32_CXX_OPTS=-bt=nt -DZIL_WIN32 -w4 -j -oaxt
...
copy_out: .PROCEDURE .EXPLICIT
	...
	$(COPY) $(pname).hpp ..$(S)include
	$(COPY) $(datname).dat ..$(S)..$(S)bin$(S)$(datname).znc
