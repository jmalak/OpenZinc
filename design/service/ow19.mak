...
template_lib_objs = $(pname)$(oext)

template_dep_libs = $(prfx)service.lib
...
WIN_LINK_OPTS=SYSTEM windows OP heapsize=16k,stack=30k
...
copy_out: .PROCEDURE .EXPLICIT
	$(COPY) $@ ..$(S)..$(S)lib$(S)$(VERSION)
	$(COPY) $(pname).hpp ..$(S)..$(S)include
