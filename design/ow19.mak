...
LINK_OPTS=libpath 'lib/ow19' libpath '../lib/ow19'
LIB_OPTS=-pa -n
RC_OPTS=-r

# ----- DOS extender compiler options ---------------------------------------
D32_CXX_OPTS=-bt=dos -dDOS386
#D32_LINK_OPTS=SYSTEM dos4g OP stack=48000
D32_LINK_OPTS=SYSTEM causeway OP stack=48000
D32_OBJS=
...
usage: .SYMBOLIC
	...
	@echo wmake -h -f ow19.mak dos32	(makes the DOS designer)
	@echo wmake -h -f ow19.mak windows	(makes the 16-bit Windows designer)
	@echo wmake -h -f ow19.mak winnt	(makes the Windows NT designer)
	@echo wmake -h -f ow19.mak win32	(makes the Windows WIN32 designer)
	@echo wmake -h -f ow19.mak os2		(makes the OS/2 designer)
	@echo wmake -h -f ow19.mak curses	(makes the Linux Curses designer)
	@echo wmake -h -f ow19.mak motif	(makes the Linux Motif designer)
	@echo ...........
	@echo ...........
...
#	----- Level 1 Applications -----
	cd service
	wmake -h -f ow19.mak $(%MODULES_FUNC)
	@cd ..
