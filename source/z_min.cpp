...
static ZIL_ICHAR _stringID[] = { 'N','U','M','I','D','_','M','I','N','I','M','I','Z','E', 0 };

#define ZIL_UIW_MINIMIZE_BUTTON_DATA
#include "img_def.cpp"
...
UIW_MINIMIZE_BUTTON::UIW_MINIMIZE_BUTTON(void) :
	...
	ZIL_NULLF(ZIL_USER_FUNCTION), L_MINIMIZE, ZIL_NULLP(ZIL_ICHAR))
{
	// Initialize the minimize button information.
	UIW_MINIMIZE_BUTTON::Information(I_INITIALIZE_CLASS, ZIL_NULLP(void));
}
...
void *UIW_MINIMIZE_BUTTON::Information(ZIL_INFO_REQUEST request, void *data, ZIL_OBJECTID objectID)
{
	// Switch on the request.
	if (objectID == ID_DEFAULT)
		objectID = ID_MINIMIZE_BUTTON;
	switch (request)
	{
	case I_INITIALIZE_CLASS:
		...
		searchID = WindowID(ID_MINIMIZE_BUTTON);
		...
		UIW_MINIMIZE_BUTTON::UpdateSettings(objectID);
		break;
...
void UIW_MINIMIZE_BUTTON::UpdateSettings(ZIL_OBJECTID objectID)
{
	// Check the environment specific flag settings.
	UIW_MINIMIZE_BUTTON::OSUpdateSettings(objectID);
}

// ----- ZIL_PERSISTENCE ----------------------------------------------------

#if defined(ZIL_LOAD)
ZIL_NEW_FUNCTION UIW_MINIMIZE_BUTTON::NewFunction(void) { return (UIW_MINIMIZE_BUTTON::New); }

UIW_MINIMIZE_BUTTON::UIW_MINIMIZE_BUTTON(const ZIL_ICHAR *name, ZIL_STORAGE_READ_ONLY *directory,
	ZIL_STORAGE_OBJECT_READ_ONLY *file, UI_ITEM *objectTable, UI_ITEM *userTable) :
	UIW_BUTTON(0, 0, 0, ZIL_NULLP(ZIL_ICHAR), BTF_SEND_MESSAGE,
	WOF_BORDER | WOF_JUSTIFY_CENTER | WOF_SUPPORT_OBJECT | WOF_NON_FIELD_REGION,
	ZIL_NULLF(ZIL_USER_FUNCTION), L_MINIMIZE)
{
	// Initialize the minimize button information.
	UIW_MINIMIZE_BUTTON::Load(name, directory, file, objectTable, userTable);
	UI_WINDOW_OBJECT::Information(I_INITIALIZE_CLASS, ZIL_NULLP(void));
	UIW_BUTTON::Information(I_INITIALIZE_CLASS, ZIL_NULLP(void));
	UIW_MINIMIZE_BUTTON::Information(I_INITIALIZE_CLASS, ZIL_NULLP(void));
}

void UIW_MINIMIZE_BUTTON::Load(const ZIL_ICHAR *, ZIL_STORAGE_READ_ONLY *,
...
void UIW_MINIMIZE_BUTTON::Store(const ZIL_ICHAR *, ZIL_STORAGE *,
