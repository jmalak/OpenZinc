...
LRESULT FAR PASCAL _export VListJumpProcedure(HWND hWnd, WORD wMsg, WPARAM wParam, LPARAM lParam)
{
...
#if ZIL_MSWINDOWS >= 0x030a
					SendMessage(screenID, LB_SETITEMHEIGHT, object->ListIndex(), (LPARAM)object->relative.Height());
#endif
				}
			}
			ccode = UIW_WINDOW::Event(event);
